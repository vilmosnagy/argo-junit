...
import eu.vnagy.argotools.junit.VolumesEmptyDirBase;
...
/**
 * Runs the upstream {@code volumes-emptydir} example through a Docker-in-Docker (DinD) daemon.
 *
 * <p>Same reasoning as {@link EmptyDirVolumeDindTest}: the {@code emptyDir} bind-mount is
 * DinD-compatible because the directory is intentionally empty on both sides. This test is
 * expected to <b>pass</b> before and after the DinD fix.
 *
 ...
 */
class VolumesEmptyDirDindTest extends VolumesEmptyDirBase {
